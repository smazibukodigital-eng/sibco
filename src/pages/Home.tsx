...
import { ArrowRight, BarChart3, CheckCircle2, Mail, MonitorSmartphone, X, Zap } from 'lucide-react';
...
export default function Home() {
  return (
    <>
      ...
      {/* Legacy Contact Section - Replaced by proper routing but kept here as a section if they scroll */}
      <section id="contact-legacy" className="py-24 bg-emerald-500">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="mt-6 text-sm text-emerald-100">Or email us directly: info@sibcogrowthpartners.co.za</p>
        </div>
      </section>
    </>
  );
